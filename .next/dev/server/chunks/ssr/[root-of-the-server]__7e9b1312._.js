...
;
const CustomCursor = ()=>{
    const cursorRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null); // The ring
    const dotRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null); // The dot
    // Position State
    ...
    const isFirstMove = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(true); // Track first movement to prevent entry animation
    ...
    const bounceStartTime = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    const lastIdleLevel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(0);
    const targetBounceCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(0);
    // Interaction State
    ...
    const [isVisible, setIsVisible] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false); // Controls initial render visibility
    // Ripple State
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const updateCursorState = (clientX, clientY, eventTarget)=>{
            lastMoveTime.current = Date.now(); // Reset idle timer
...
"[project]/data/constants.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const Navbar = ()=>{
    ...
    const pathname = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["usePathname"])() || '/'; // fallback to '/' if null
    ...
    const isCurrentPage = (page)=>page === '/' ? pathname === '/' : pathname.startsWith(page);
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                        ...
                        children: [
                            [
                                ...
                                '/blog'
                                    ...
                                    className: `text-[11px] lg:text-sm uppercase tracking-wider font-medium transition-colors relative group py-2 ${isCurrentPage(page) ? 'text-white' : 'text-jambo-100 hover:text-white'}`,
                                    children: [
                                        page === '/' ? 'Home' : page.replace('/', '').replace(/^\w/, (c)=>c.toUpperCase()),
                                        isCurrentPage(page) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Theme$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ThemeToggle"], {
                                className: "hidden md:block",
                                lightModeClass: "bg-jambo-700 text-white hover:bg-jambo-800"
                            }, void 0, false, {
                                fileName: "[project]/components/Navbar.tsx",
                                lineNumber: 77,
                                columnNumber: 11
                    ...
                    children: [
                        [
                            ...
                            '/blog'
                                ...
                                onClick: ()=>handleNav(page),
                                className: `uppercase tracking-widest py-2 text-xl font-${page === '/' ? 'medium' : 'light'} ${isCurrentPage(page) ? 'text-white' : 'text-jambo-100 hover:text-white'}`,
                                children: page === '/' ? 'Home' : page.replace('/', '').replace(/^\w/, (c)=>c.toUpperCase())
                            }, page, false, {
                                fileName: "[project]/components/Navbar.tsx",
                                lineNumber: 101,
                                columnNumber: 15
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Theme$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ThemeToggle"], {
                                lightModeClass: "bg-jambo-700 text-white w-12 h-12 flex items-center justify-center hover:bg-jambo-800"
                            }, void 0, false, {
                                fileName: "[project]/components/Navbar.tsx",
                                lineNumber: 113,
                                columnNumber: 15
...
"[project]/data/source/jobs.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/data/source/users.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/data/source/notifications.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/data/source/courses.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/data/source/lessons.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/data/source/resources.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/data/source/invoices.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/data/source/loginHistory.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/data/source/compliance.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/data/source/certificates.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/data/source/messages.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/data/source/blogPosts.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$source$2f$jobs$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/source/jobs.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$source$2f$users$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/source/users.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$source$2f$notifications$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/source/notifications.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$source$2f$courses$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/source/courses.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$source$2f$lessons$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/source/lessons.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$source$2f$resources$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/source/resources.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$source$2f$invoices$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/source/invoices.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$source$2f$loginHistory$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/source/loginHistory.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$source$2f$compliance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/source/compliance.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$source$2f$certificates$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/source/certificates.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$source$2f$messages$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/source/messages.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$source$2f$blogPosts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/source/blogPosts.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/constants.ts [app-ssr] (ecmascript)");
;
;
;
...
class DataStore {
    jobs = [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$source$2f$jobs$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initialJobs"]
    ];
    users = [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$source$2f$users$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initialUsers"]
    ];
    notifications = [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$source$2f$notifications$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initialNotifications"]
    ];
    courses = [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$source$2f$courses$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initialCourses"]
    ];
    courseProgress = [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$source$2f$courses$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initialProgress"]
    ];
    lessons = [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$source$2f$lessons$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initialLessons"]
    ];
    certificates = [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$source$2f$certificates$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initialCertificates"]
    ];
    resources = [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$source$2f$resources$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initialResources"]
    ];
    invoices = [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$source$2f$invoices$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initialInvoices"]
    ];
    loginHistory = [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$source$2f$loginHistory$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initialLoginHistory"]
    ];
    complianceDocs = [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$source$2f$compliance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initialComplianceDocs"]
    ];
    messages = [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$source$2f$messages$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initialMessages"]
    ];
    blogPosts = [
        ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$source$2f$blogPosts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initialBlogPosts"]
    ];
    // New: Email Storage
    emailTemplates = [
        {
    ...
    settings = {
        ...
        // SEO Defaults
        seo: {
            siteTitle: __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["COMPANY_INFO"].name,
            ...
            structuredData: JSON.stringify({
                ...
                "@type": "Organization",
                "name": __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["COMPANY_INFO"].name,
                "url": "https://jambolinguists.com",
                "logo": __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["COMPANY_INFO"].logoUrl,
                "contactPoint": {
                    "@type": "ContactPoint",
                    "telephone": __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["COMPANY_INFO"].phone,
                    "contactType": "customer service",
                    "email": __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["COMPANY_INFO"].email
                },
                "address": {
                    "@type": "PostalAddress",
...
"[project]/data/services/AuthService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class AuthService {
    ...
    init() {
        ...
        if (storedId) {
            const user = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users.find((u)=>u.id === storedId && !u.deletedAt && !u.isSuspended);
            if (user) {
                __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId = user.id;
            } else {
                // Invalid or deleted user in storage
                localStorage.removeItem('jambo_auth_user');
                __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId = null;
            }
        }
    }
    login(email, password) {
        const user = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users.find((u)=>u.email.toLowerCase() === email.toLowerCase() && !u.deletedAt);
        if (!user) {
            return {
                success: false,
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].loginHistory.unshift({
            id: __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].generateId('lh'),
            userId: user.id,
    ...
    register(data) {
        ...
        // Check if exists
        if (__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users.some((u)=>u.email.toLowerCase() === data.email.toLowerCase())) {
            return {
                success: false,
        ...
        const now = new Date().toISOString();
        const newUser = {
            id: __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].generateId('u'),
            email: data.email,
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users.push(newUser);
        // Auto-login after register
        __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId = newUser.id;
        localStorage.setItem('jambo_auth_user', newUser.id);
        // Add a welcome notification
        __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].notifications.push({
            id: __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].generateId('n'),
            userId: newUser.id,
    ...
    getCurrentUser() {
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId) return null;
        return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users.find((u)=>u.id === __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId) || null;
    }
    updateProfile(data) {
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId) return;
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users.findIndex((u)=>u.id === __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId);
        if (idx !== -1) {
            __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users[idx] = {
                ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users[idx],
                ...data,
...
"[project]/components/portal/dashboard/jobs/job-helpers.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/data/services/JobService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class JobService {
    ...
    getAvailableJobs() {
        return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs.filter((j)=>j.status === 'Open' && !j.deletedAt);
    }
    getBookedJobs() {
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId) return [];
        return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs.filter((j)=>j.linguistId === __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId && [
                'Scheduled',
                'In Progress',
                'Revision'
    ...
    getNextAssignment() {
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId) return null;
        const booked = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs.filter((j)=>j.linguistId === __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId && [
                'Scheduled',
                'In Progress'
    ...
    unassignJob(jobId, userId) {
        const index = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs.findIndex((j)=>j.id === jobId);
        if (index !== -1) {
            const job = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs[index];
            ...
            const currentUser = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users.find((u)=>u.id === userId);
            ...
            const newHistory = [
                ...job.history || [],
                {
                    id: __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].generateId('h'),
                    type: 'ASSIGNED',
                    date: now,
                    actorName: actorName,
            ...
            // Reset job
            __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs[index] = {
                ...job,
                linguistId: null,
                status: 'Open',
                history: newHistory,
    ...
    updateJobStatus(id, status, extraData) {
        const index = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs.findIndex((j)=>j.id === id);
        if (index !== -1 && !__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs[index].deletedAt) {
            const job = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs[index];
            const oldStatus = job.status;
            const currentUser = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users.find((u)=>u.id === __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId);
            ...
            if (status === 'Completed' && !updatedJob.totalPayout) {
                updatedJob.totalPayout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$portal$2f$dashboard$2f$jobs$2f$job$2d$helpers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateJobPayout"])(updatedJob);
            }
            __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs[index] = updatedJob;
...
"[project]/data/services/AdminService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class AdminService {
    ...
    getAllJobs() {
        ...
        return [
            ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs
        ].filter((j)=>!j.deletedAt).sort((a, b)=>new Date(b.date).getTime() - new Date(a.date).getTime());
    }
    getAllUsers() {
        return [
            ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users
        ].filter((u)=>!u.deletedAt).sort((a, b)=>new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime());
    }
    getAllInvoices() {
        return [
            ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].invoices
        ].filter((i)=>!i.deletedAt);
    }
    getJobsByUser(userId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs.filter((j)=>j.linguistId === userId && !j.deletedAt).sort((a, b)=>new Date(b.date).getTime() - new Date(a.date).getTime());
    }
    getInvoicesByUser(userId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].invoices.filter((i)=>i.userId === userId && !i.deletedAt).sort((a, b)=>new Date(b.date).getTime() - new Date(a.date).getTime());
    }
    // --- SYSTEM SETTINGS ---
    getSettings() {
        return {
            ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].settings
        };
    }
    updateSettings(newSettings) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].settings;
    }
    // --- COMPLIANCE ---
    getComplianceDocs() {
        return [
            ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].complianceDocs
        ].filter((d)=>!d.deletedAt);
    }
    updateComplianceDoc(id, content, title) {
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].complianceDocs.findIndex((d)=>d.id === id);
        if (idx !== -1) {
            __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].complianceDocs[idx] = {
                ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].complianceDocs[idx],
                content,
                title: title || __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].complianceDocs[idx].title,
    ...
    createResource(resource) {
        const newResource = {
            id: __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].generateId('res'),
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].resources.unshift(newResource);
        return newResource;
    }
    updateResource(id, updates) {
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].resources.findIndex((r)=>r.id === id);
        if (idx !== -1) {
            __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].resources[idx] = {
                ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].resources[idx],
                ...updates,
                updatedAt: new Date().toISOString()
            };
    ...
    deleteResource(id) {
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].resources.findIndex((r)=>r.id === id);
        if (idx !== -1) {
            __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].resources[idx].deletedAt = new Date().toISOString();
        }
    }
    // --- EMAIL ---
    updateEmailTemplate(id, updates) {
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].emailTemplates.findIndex((t)=>t.id === id);
        if (idx !== -1) {
            __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].emailTemplates[idx] = {
                ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].emailTemplates[idx],
                ...updates
            };
        }
    ...
    getEmailLogs() {
        return [
            ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].emailLogs
        ].sort((a, b)=>new Date(b.sentAt).getTime() - new Date(a.sentAt).getTime());
    }
    // --- JOBS & FINANCE ---
    approveJobSubmission(jobId) {
        const jobIndex = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs.findIndex((j)=>j.id === jobId);
        if (jobIndex === -1) throw new Error('Job not found');
        const job = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs[jobIndex];
        const currentUser = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users.find((u)=>u.id === __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId);
        const now = new Date().toISOString();
        const newInvoice = {
            id: `inv-${Date.now()}`,
            ...
            amount: job.totalPayout || (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$portal$2f$dashboard$2f$jobs$2f$job$2d$helpers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateJobPayout"])(job) || 0,
            status: 'Pending',
            items: [
                {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].invoices.unshift(newInvoice);
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs[jobIndex] = {
            ...job,
            status: 'Completed',
            history: newHistory,
            completedAt: now,
    ...
    adminForceCompleteJob(jobId, notes) {
        ...
        const updatedJob = {
            ...
            totalPayout: job.totalPayout || (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$portal$2f$dashboard$2f$jobs$2f$job$2d$helpers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calculateJobPayout"])(job)
        };
        __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs[jobIndex] = updatedJob;
        return updatedJob;
    }
    createUser(userData) {
        const now = new Date().toISOString();
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users.unshift(newUser);
        return newUser;
    }
    updateUser(userId, data) {
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users.findIndex((u)=>u.id === userId);
        if (idx !== -1) {
            __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users[idx] = {
                ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users[idx],
                ...data,
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users[idx];
        }
        return null;
    }
    updateUserVerification(userId, isVerified) {
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users.findIndex((u)=>u.id === userId);
        if (idx !== -1) {
            __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users[idx].isVerified = isVerified;
            if (isVerified) __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users[idx].isSuspended = false;
            __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users[idx].updatedAt = new Date().toISOString();
        }
    }
    suspendUser(userId, isSuspended) {
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users.findIndex((u)=>u.id === userId);
        if (idx !== -1) {
            __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users[idx].isSuspended = isSuspended;
            __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users[idx].updatedAt = new Date().toISOString();
        }
    }
    createJob(jobData) {
        ...
        if (jobData.linguistId) {
            const linguist = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users.find((u)=>u.id === jobData.linguistId);
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs.unshift(newJob);
        return newJob;
    }
    updateJobDetails(jobId, updates, newFiles, keptAttachments) {
        const index = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs.findIndex((j)=>j.id === jobId);
        if (index !== -1) {
            const oldJob = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs[index];
            const currentUser = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users.find((u)=>u.id === __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId);
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs[index];
        }
        return null;
    }
    assignJob(jobId, linguistId) {
        ...
        if (index !== -1) {
            const currentUser = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users.find((u)=>u.id === __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId);
            const actorName = currentUser ? `${currentUser.firstName} ${currentUser.lastName}` : 'Admin';
            const oldLinguistId = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs[index].linguistId;
            const now = new Date().toISOString();
            // Only add history if changing assignment
            if (oldLinguistId !== linguistId) {
                const newHistory = [
                    ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs[index].history || []
                ];
                if (linguistId) {
                    const linguist = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users.find((u)=>u.id === linguistId);
                    const name = linguist ? `${linguist.firstName} ${linguist.lastName}` : 'Linguist';
                    newHistory.push({
                        id: __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].generateId('h'),
                        type: 'ASSIGNED',
                ...
                // Notify Assigned
                if (linguistId) {
                    this.notifications.notifyJobAssigned(linguistId, __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs[index]);
                }
            }
        }
    }
    getLoginHistoryForUser(userId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].loginHistory.filter((entry)=>entry.userId === userId).sort((a, b)=>new Date(b.timestamp).getTime() - new Date(a.timestamp).getTime());
    }
    logImpersonation(adminId, targetUserId) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].loginHistory.unshift(newEntry);
    }
}
}),
"[project]/data/services/TrainingService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class TrainingService {
    ...
    getCourses() {
        return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courses.filter((c)=>!c.deletedAt).map((course)=>{
            const progress = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId ? __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courseProgress.find((p)=>p.userId === __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId && p.courseId === course.id) : undefined;
            return {
                ...course,
                progress
            };
    ...
    getCourse(courseId) {
        const course = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courses.find((c)=>c.id === courseId && !c.deletedAt);
        if (!course) return undefined;
        const progress = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId ? __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courseProgress.find((p)=>p.userId === __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId && p.courseId === courseId) : undefined;
        return {
            ...course,
            progress
        };
    ...
    getLessons(courseId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].lessons.filter((l)=>l.courseId === courseId && !l.deletedAt).sort((a, b)=>a.orderIndex - b.orderIndex);
    }
    getCourseProgress(courseId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courseProgress.filter((p)=>p.courseId === courseId);
    }
    enrollCourse(courseId) {
        ...
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].settings.globalSelfEnrollment) {
            return {
                success: false,
        ...
        if (__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].settings.requirePrerequisites && course.settings.prerequisites && course.settings.prerequisites.length > 0) {
            const userCompletedIds = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courseProgress.filter((p)=>p.userId === __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId && p.status === 'Completed').map((p)=>p.courseId);
        ...
        const exists = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courseProgress.find((p)=>p.userId === __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId && p.courseId === courseId);
        if (exists) return {
            success: true,
            message: 'Already enrolled.'
        };
        // Create initial progress record
        __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courseProgress.push({
            userId: __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId,
            courseId: courseId,
            status: 'In Progress',
            progressPercent: 0,
            lessonsCompletedIds: [],
    ...
    completeLesson(courseId, lessonId) {
        ...
        let progress = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courseProgress.find((p)=>p.userId === __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId && p.courseId === courseId);
        if (!progress) {
            progress = {
                userId: __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId,
                courseId: courseId,
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courseProgress.push(progress);
        }
        ...
        if (!progress.lessonsCompletedIds.includes(lessonId)) {
            ...
            const lessonTitle = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].lessons.find((l)=>l.id === lessonId)?.title || 'Lesson';
            progress.history = [
                ...progress.history || [],
                {
                    date: new Date().toISOString(),
        ...
        // Calculate percent
        const totalLessons = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].lessons.filter((l)=>l.courseId === courseId && !l.deletedAt).length;
        if (totalLessons > 0) {
        ...
        if (progress.progressPercent === 100 && progress.status !== 'Completed') {
            ...
            const course = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courses.find((c)=>c.id === courseId);
            // Notification System
            const hasNotif = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].notifications.some((n)=>n.title.includes(`Course Completed: ${course?.title}`));
            if (!hasNotif) {
                const now = new Date().toISOString();
                __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].notifications.unshift({
                    id: __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].generateId('n'),
                    userId: __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId,
                ...
                // --- NEW: Send Email ---
                if (course) {
                    this.notifications.notifyCourseCompleted(__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId, course.title);
                }
            }
        }
    }
    checkCompliance(requiredCourseIds) {
        ...
        const userProgress = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courseProgress.filter((p)=>p.userId === __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId && p.status === 'Completed');
        const completedIds = userProgress.map((p)=>p.courseId);
        const missing = requiredCourseIds.filter((id)=>!completedIds.includes(id));
        const missingTitles = missing.map((id)=>__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courses.find((c)=>c.id === id)?.title || id);
        return {
    ...
    getCertificates() {
        ...
        const userCertificates = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].certificates.filter((cert)=>cert.userId === __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId && cert.status === 'Active' && !cert.deletedAt);
        // Map these certificates back to their courses
        return userCertificates.map((cert)=>{
            const course = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courses.find((c)=>c.id === cert.courseId && !c.deletedAt);
            if (!course) return null;
            const progress = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courseProgress.find((p)=>p.userId === __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId && p.courseId === cert.courseId);
            return {
                ...course,
                progress: progress ? {
                    ...progress,
...
"[project]/data/services/FinanceService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class FinanceService {
    ...
    getInvoices() {
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId) return [];
        return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].invoices.filter((inv)=>inv.userId === __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId && !inv.deletedAt).sort((a, b)=>new Date(b.date).getTime() - new Date(a.date).getTime());
    }
    createInvoice(invoice) {
        __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].invoices.unshift(invoice);
    ...
    updateInvoice(invoice) {
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].invoices.findIndex((i)=>i.id === invoice.id);
        if (idx !== -1) {
            const oldInvoice = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].invoices[idx];
            __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].invoices[idx] = {
                ...invoice,
                updatedAt: new Date().toISOString()
            };
    ...
    updateInvoiceStatus(id, status) {
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].invoices.findIndex((i)=>i.id === id);
        if (idx !== -1) {
            const invoice = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].invoices[idx];
            const now = new Date().toISOString();
            ...
            if (status === 'Paid') {
                ...
                for (const item of invoice.items){
                    if (item.jobId) {
                        const jobIndex = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs.findIndex((j)=>j.id === item.jobId);
                        if (jobIndex !== -1) {
                            const job = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs[jobIndex];
                            const newHistory = [
                                ...job.history || []
    ...
    getFinanceStats() {
        ...
        const userInvoices = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].invoices.filter((inv)=>inv.userId === __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId && !inv.deletedAt);
    ...
    getStats() {
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId) {
            return {
                earnings: "£0",
        ...
        const completed = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs.filter((j)=>j.linguistId === __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId && j.status === 'Completed' && !j.deletedAt);
...
"[project]/data/services/NotificationService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class NotificationService {
    create(userId, title, message, type, link) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].notifications.unshift(newNotification);
    }
    // Helper for colors
    getBgColor(type) {
        switch(type){
    ...
    sendEmail(userId, templateId, data) {
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].settings.email.enabled) {
            console.log(`[Email] Skipped (Disabled): ${templateId} to ${userId}`);
            return;
        }
        const user = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users.find((u)=>u.id === userId);
        if (!user || !user.email) {
        ...
        const template = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].emailTemplates.find((t)=>t.id === templateId);
        if (!template) {
        ...
        // "Send" (Log it)
        const log = {
            id: __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].generateId('mail'),
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].emailLogs.unshift(log);
    ...
    notifyJobCompletedPending(job) {
        // Notify Admins
        const admins = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users.filter((u)=>u.role === 'admin' && !u.deletedAt);
        const linguist = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users.find((u)=>u.id === job.linguistId);
...
"[project]/data/services/CertificateService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class CertificateService {
    ...
    issueCertificate(userId, courseId, templateId) {
        ...
        const newCert = {
            id: __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].generateId('cert'),
            userId,
            courseId,
            issueDate: now,
            status: 'Active',
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].certificates.push(newCert);
        // 2. Link to Course Progress
        const progressIdx = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courseProgress.findIndex((p)=>p.userId === userId && p.courseId === courseId);
        if (progressIdx !== -1) {
            __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courseProgress[progressIdx] = {
                ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courseProgress[progressIdx],
    ...
    revokeCertificate(certificateId) {
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].certificates.findIndex((c)=>c.id === certificateId);
        if (idx !== -1) {
            __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].certificates[idx].status = 'Revoked';
            __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].certificates[idx].updatedAt = new Date().toISOString();
    ...
    reissueCertificate(certificateId) {
        const oldCert = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].certificates.find((c)=>c.id === certificateId);
    ...
    getCertificate(id) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].certificates.find((c)=>c.id === id && !c.deletedAt);
    }
    getUserCertificates(userId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].certificates.filter((c)=>c.userId === userId && !c.deletedAt);
    }
}
}),
"[project]/data/services/LmsAdminService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class LmsAdminService {
    ...
    saveCourse(courseData, lessons) {
        ...
        const courseId = courseData.id || __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].generateId('c');
        const now = new Date().toISOString();
        const newCourse = {
            id: courseId,
        ...
        if (isNew) {
            __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courses.push(newCourse);
        } else {
            const idx = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courses.findIndex((c)=>c.id === courseId);
            if (idx !== -1) {
                __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courses[idx] = newCourse;
            }
        }
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].lessons = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].lessons.filter((l)=>l.courseId !== courseId);
        const newLessons = lessons.map((l, index)=>({
                ...l,
                id: l.id.startsWith('temp-') ? __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].generateId('l') + index : l.id,
                courseId: courseId,
                orderIndex: index,
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].lessons.push(...newLessons);
        return newCourse;
    }
    deleteCourse(courseId) {
        ...
        if (idx !== -1) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courses[idx].deletedAt = new Date().toISOString();
            // Soft delete related lessons
            __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].lessons.forEach((l)=>{
                if (l.courseId === courseId) l.deletedAt = new Date().toISOString();
            });
        }
    }
    enrollUser(courseId, userId) {
        if (__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courseProgress.some((p)=>p.courseId === courseId && p.userId === userId)) return;
        __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courseProgress.push({
            userId,
            courseId,
            status: 'In Progress',
    ...
    removeUser(courseId, userId) {
        __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courseProgress = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courseProgress.filter((p)=>!(p.courseId === courseId && p.userId === userId));
    }
    updateLearnerProgress(courseId, userId, updates) {
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courseProgress.findIndex((p)=>p.courseId === courseId && p.userId === userId);
        if (idx !== -1) {
            const current = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courseProgress[idx];
            const newHistory = [
                ...current.history || []
            ];
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courseProgress[idx] = {
                ...current,
                ...updates,
                history: newHistory,
    ...
    updateCourseSettings(courseId, updates) {
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courses.findIndex((c)=>c.id === courseId);
        if (idx !== -1) {
            __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courses[idx] = {
                ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].courses[idx],
                ...updates,
                updatedAt: new Date().toISOString()
            };
...
"[project]/data/services/MessageService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class MessageService {
    ...
    getAllMessages() {
        return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].messages;
    }
    getConversations(userId) {
        const userMessages = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].messages.filter((m)=>m.senderId === userId || m.recipientId === userId && !m.deletedAt);
        ...
        const conversations = Object.keys(groups).map((key)=>{
            ...
            const peer = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users.find((u)=>u.id === peerId);
            const job = lastMessage.jobId ? __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].jobs.find((j)=>j.id === lastMessage.jobId) : undefined;
            return {
                peerId,
    ...
    getThread(userId, peerId, jobId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].messages.filter((m)=>(m.senderId === userId && m.recipientId === peerId || m.senderId === peerId && m.recipientId === userId) && m.jobId === (jobId || undefined) && !m.deletedAt).sort((a, b)=>new Date(a.createdAt).getTime() - new Date(b.createdAt).getTime()); // Oldest first for chat view
    }
    sendMessage(senderId, recipientId, content, jobId) {
        const now = new Date().toISOString();
        const newMessage = {
            id: __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].generateId('m'),
            senderId,
            recipientId,
            content,
            jobId,
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].messages.push(newMessage);
        // Notify Recipient (Email)
        const sender = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users.find((u)=>u.id === senderId);
    ...
    markAsRead(userId, peerId, jobId) {
        let updated = false;
        __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].messages.forEach((m)=>{
    ...
    getGlobalUnreadCount(userId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].messages.filter((m)=>m.recipientId === userId && !m.isRead && !m.deletedAt).length;
    }
}
}),
"[project]/data/services/BlogService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class BlogService {
    getAllBlogs(includeDrafts = false) {
        let posts = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].blogPosts.filter((p)=>!p.deletedAt);
        if (!includeDrafts) {
    ...
    getBlogBySlug(slug) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].blogPosts.find((p)=>p.slug === slug && !p.deletedAt);
    }
    createBlog(data) {
        const now = new Date().toISOString();
        const currentUser = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].users.find((u)=>u.id === __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId);
        const newPost = {
            id: __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].generateId('blog'),
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].blogPosts.unshift(newPost);
        return newPost;
    }
    updateBlog(id, updates) {
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].blogPosts.findIndex((p)=>p.id === id);
        if (idx !== -1) {
            const current = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].blogPosts[idx];
            const now = new Date().toISOString();
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].blogPosts[idx] = {
                ...current,
                ...updates,
                publishedAt,
                updatedAt: now
            };
            return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].blogPosts[idx];
        }
        return null;
    }
    deleteBlog(id) {
        const idx = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].blogPosts.findIndex((p)=>p.id === id);
        if (idx !== -1) {
            __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].blogPosts[idx].deletedAt = new Date().toISOString();
        }
    }
    searchBlogs(query) {
...
"[project]/data/services/AiWritingService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class AiWritingService {
    ...
    constructor(){
        ...
        const apiKey = process.env.NEXT_PUBLIC_GEMINI_API_KEY || ("TURBOPACK compile-time value", "AIzaSyCR8zJB-vpJUm6hMzIn9fQvdjK26grx2_0");
        if ("TURBOPACK compile-time truthy", 1) {
            try {
                this.ai = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$google$2f$genai$2f$dist$2f$node$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GoogleGenAI"]({
                    apiKey
                });
                this.isEnabled = true;
...
"[project]/data/mockDatabase.ts [app-ssr] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$services$2f$AuthService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/services/AuthService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$services$2f$JobService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/services/JobService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$services$2f$AdminService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/services/AdminService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$services$2f$TrainingService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/services/TrainingService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$services$2f$FinanceService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/services/FinanceService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$services$2f$NotificationService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/services/NotificationService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$services$2f$CertificateService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/services/CertificateService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$services$2f$LmsAdminService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/services/LmsAdminService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$services$2f$MessageService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/services/MessageService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$services$2f$BlogService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/services/BlogService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$services$2f$AiWritingService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/services/AiWritingService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/store.ts [app-ssr] (ecmascript)");
// Re-export types
...
const notificationService = new __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$services$2f$NotificationService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NotificationService"]();
const authService = new __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$services$2f$AuthService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AuthService"]();
const jobService = new __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$services$2f$JobService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["JobService"](notificationService);
const adminService = new __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$services$2f$AdminService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AdminService"](notificationService);
const certificateService = new __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$services$2f$CertificateService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CertificateService"](notificationService);
const lmsAdminService = new __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$services$2f$LmsAdminService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LmsAdminService"](notificationService, certificateService);
const trainingService = new __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$services$2f$TrainingService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TrainingService"](notificationService);
const financeService = new __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$services$2f$FinanceService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FinanceService"](notificationService);
const messageService = new __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$services$2f$MessageService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MessageService"](notificationService);
const blogService = new __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$services$2f$BlogService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BlogService"]();
const aiWritingService = new __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$services$2f$AiWritingService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AiWritingService"]();
...
const mockDb = {
    ...
    get emailTemplates () {
        return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].emailTemplates;
    },
    get emailLogs () {
        return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].emailLogs;
    },
    ...
    getNotifications: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].notifications.filter((n)=>n.userId === __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId).sort((a, b)=>new Date(b.time).getTime() - new Date(a.time).getTime()),
    markNotificationRead: (id)=>{
        const n = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].notifications.find((item)=>item.id === id);
        if (n) {
            n.isRead = true;
    ...
    markAllNotificationsRead: ()=>{
        let updated = false;
        __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].notifications.forEach((n)=>{
            if (n.userId === __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].currentUserId && !n.isRead) {
                n.isRead = true;
                n.updatedAt = new Date().toISOString();
                updated = true;
            }
    ...
    getResources: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].resources.filter((r)=>!r.deletedAt)
};
}),
...
function ClientLayout({ children }) {
    ...
    // Initialize auth
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockDatabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["mockDb"].auth.init();
    }, []);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7e9b1312._.js.map