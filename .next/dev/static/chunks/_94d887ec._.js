...
const CustomCursor = ()=>{
    _s();
    const cursorRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null); // The ring
    const dotRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null); // The dot
    // Position State
    ...
    const isFirstMove = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(true); // Track first movement to prevent entry animation
    ...
    const bounceStartTime = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const lastIdleLevel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    const targetBounceCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    // Interaction State
    ...
    const [isVisible, setIsVisible] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // Controls initial render visibility
    // Ripple State
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CustomCursor.useEffect": ()=>{
            ...
            const handlePointerDown = {
                "CustomCursor.useEffect.handlePointerDown": (e)=>{
                    const newRipple = {
                        id: Date.now(),
                        x: e.clientX,
                        y: e.clientY
                    ...
                    setRipples({
                        "CustomCursor.useEffect.handlePointerDown": (prev)=>[
                                ...prev,
                                newRipple
                            ]
                    ...
                    setTimeout({
                        "CustomCursor.useEffect.handlePointerDown": ()=>{
                            setRipples({
                                "CustomCursor.useEffect.handlePointerDown": (prev)=>prev.filter({
                                        "CustomCursor.useEffect.handlePointerDown": (r)=>r.id !== newRipple.id
                                    }["CustomCursor.useEffect.handlePointerDown"])
                            }["CustomCursor.useEffect.handlePointerDown"]);
                        }
                    }["CustomCursor.useEffect.handlePointerDown"], 600);
                }
            }["CustomCursor.useEffect.handlePointerDown"];
            window.addEventListener('pointerdown', handlePointerDown);
            // --- Shared Logic for updating cursor state ---
            const updateCursorState = {
                "CustomCursor.useEffect.updateCursorState": (clientX, clientY, eventTarget)=>{
                    lastMoveTime.current = Date.now(); // Reset idle timer
            ...
            }["CustomCursor.useEffect.updateCursorState"];
            // --- Event Handlers ---
            const onMouseMove = {
            ...
            const onTouchMove = {
                "CustomCursor.useEffect.onTouchMove": (e)=>{
            ...
            }["CustomCursor.useEffect.onTouchMove"];
            const onDown = {
...
_s(CustomCursor, "O8v5qhZdywpozOV7Et657IaWQJ8=");
_c = CustomCursor;
var _c;
...
const Navbar = ()=>{
    ...
    const pathname = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"])() || '/'; // fallback to '/' if null
                            ...
                            [
                                ...
                                '/blog'
                                    ...
                                    children: [
                                        ...
                                        isCurrentPage(page) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(Navbar, "T2Te04LL+WI1sfr+aJcfkClyOho=", false, function() {
    return [
...
class AiWritingService {
    ...
    constructor(){
        ...
        const apiKey = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_GEMINI_API_KEY || ("TURBOPACK compile-time value", "AIzaSyCR8zJB-vpJUm6hMzIn9fQvdjK26grx2_0");
...
//# sourceMappingURL=_94d887ec._.js.map