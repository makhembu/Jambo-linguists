  ...
  return (
    <div className="flex h-screen w-full bg-gray-50 dark:bg-[#0f0a15] font-sans text-gray-800 dark:text-gray-200 transition-colors duration-300 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 relative h-full">
         ...
         <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-10 scroll-smooth pb-24 lg:pb-10 custom-scrollbar bg-gray-50 dark:bg-[#0f0a15]">
      ...
      {/* Mobile Bottom Navigation - Z-Index 50 ensures visibility over content but under Modals (z-60) */}
      <BottomNav 
        activeSection={activeSection} 
